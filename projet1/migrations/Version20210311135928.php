 ...
 */
final class Version20210311135928 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE eleve (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, photo VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE rattrapage (id INT AUTO_INCREMENT NOT NULL, pdfcorrige VARCHAR(255) NOT NULL, date_rattrapage DATETIME NOT NULL, duree_rattrapage TIME NOT NULL, corrige VARCHAR(255) DEFAULT NULL, support_sonore TINYINT(1) NOT NULL, etat_rattrapage INT NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
